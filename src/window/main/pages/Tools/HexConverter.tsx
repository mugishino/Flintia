    ...
    return (
        <>
            <div className="flex flex-row">
                <input type="number" min={2} max={36} value={beforeRadix} onChange={e => setBeforeRadix(e.currentTarget.valueAsNumber.orDefault(0).keepRange(2, 36))} className="text-center w-1/6"/>
            ...
            <div className="flex flex-row">
                <input type="number" min={2} max={36} value={afterRadix} onChange={e => setAfterRadix(e.currentTarget.valueAsNumber.orDefault(0).keepRange(2, 36))} className="text-center w-1/6"/>
